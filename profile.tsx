...
import { View, Text, Alert, StyleSheet, ActivityIndicator, SafeAreaView, TouchableOpacity, ScrollView, ImageBackground, Platform } from 'react-native';
...
const Profile = () => {
  ...
  const requestMediaLibraryPermissions = async () => {
    if (Platform.OS !== 'web') {
      ...
      if (status !== 'granted') {
        Alert.alert('Permission needed', 'Please grant permission to access your media library to upload a profile picture.');
      }
    }
  };
          ...
          <View style={styles.profileContainer}>
                ...
                {uploadingImage ? (
                  ...
                  <>
                    <Avatar
                      ...
                      title={!avatarUrl ? getInitials() : undefined}
            ...
            <View style={styles.formContainer}>
              ...
              <Input
                ...
                value={employeeId}
                disabled
                leftIcon={<Icon name="hash" type="feather" size={18} color="#888" />}
                labelStyle={styles.inputLabel}
                containerStyle={styles.inputContainer}
                inputContainerStyle={styles.input}
                disabledInputStyle={styles.disabledInput}
              ...
              <View style={styles.rowContainer}>
                <Input
                  ...
                  value={department}
                  disabled
                  leftIcon={<Icon name="briefcase" type="feather" size={18} color="#888" />}
                  labelStyle={styles.inputLabel}
              ...
              <Input
                ...
                disabled
                leftIcon={<Icon name="map-pin" type="feather" size={18} color="#888" />}
                labelStyle={styles.inputLabel}
                containerStyle={styles.inputContainer}
                inputContainerStyle={styles.input}
                disabledInputStyle={styles.disabledInput}
              ...
              <View style={styles.rowContainer}>
                <Input
                  ...
                  value={dateJoined}
                  disabled
                  leftIcon={<Icon name="calendar" type="feather" size={18} color="#888" />}
                  labelStyle={styles.inputLabel}
                  containerStyle={[styles.inputContainer, styles.halfInput]}
                  inputContainerStyle={styles.input}
                  disabledInputStyle={styles.disabledInput}
            ...
            <View style={styles.formContainer}>
              ...
              <Input
                ...
                leftIcon={<Icon name="home" type="feather" size={18} color="#888" />}
                labelStyle={styles.inputLabel}
                containerStyle={styles.inputContainer}
                inputContainerStyle={styles.input}
            ...
            <View style={styles.formContainer}>
              ...
              <Input
                ...
                leftIcon={<Icon name="user-plus" type="feather" size={18} color="#888" />}
                labelStyle={styles.inputLabel}
                containerStyle={styles.inputContainer}
                inputContainerStyle={styles.input}
            ...
            <View style={styles.formContainer}>
              ...
              <Input
                ...
                leftIcon={<Icon name="globe" type="feather" size={18} color="#888" />}
                labelStyle={styles.inputLabel}
                containerStyle={styles.inputContainer}
                inputContainerStyle={styles.input}
            ...
            <View style={styles.cardContainer}>
              <View style={styles.card}>
                <Icon name="info" type="feather" size={24} color="#2089dc" />
...
const styles = StyleSheet.create({
  backgroundImage: {
    flex: 1,
    width: '100%',
    backgroundColor: '#e6f2ff', // Fallback color
  },
  safeArea: {
    flex: 1,
  },
